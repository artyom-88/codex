...
CLICKHOUSE_WRITE_PASSWORD_ENV = "SIGNOZ_CODEX_CLICKHOUSE_WRITE_PASSWORD"  # nosec B105
CLICKHOUSE_READONLY_PASSWORD_ENV = "SIGNOZ_CODEX_CLICKHOUSE_READONLY_PASSWORD"  # nosec B105
...
def ensure_runtime_assets_rendered() -> None:
    ...
    users_rendered = (
        ...
        .replace(
            ...
            _sha256_hex(os.environ[CLICKHOUSE_READONLY_PASSWORD_ENV]),
        )
        .replace(
            "__SIGNOZ_CODEX_CLICKHOUSE_WRITE_PASSWORD_SHA256_HEX__",
            _sha256_hex(os.environ[CLICKHOUSE_WRITE_PASSWORD_ENV]),
        )
    )
