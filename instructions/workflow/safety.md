...
- Treat remote-affecting actions such as pushes, deployments, or external writes as higher-risk steps.
- When a safer non-destructive check can answer the question, prefer that first.
